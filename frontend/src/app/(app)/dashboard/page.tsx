      ...
      <Container className="flex max-w-6xl flex-col gap-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            <h1 className="text-2xl font-semibold tracking-tight">{t.casesTitle}</h1>
            <p className="text-sm text-muted">{t.casesSubtitle}</p>
          </div>
          <Link href="/cases/new">
            <Button>
        ...
        {cases.length === 0 ? (
          <Card className="flex flex-col items-center gap-3 py-16 text-center">
            <h2 className="text-lg font-medium">{t.noCasesTitle}</h2>
            <p className="max-w-sm text-sm text-muted">{t.noCasesText}</p>
            <Link href="/cases/new">
              <Button>
                <Plus className="h-4 w-4" />
                {t.createFirstCase}
